...
$routes->get('admin/kategori/(.*)', 'Kategori::show/$1');
$routes->post('admin/kategori', 'Kategori::create');
$routes->post('admin/kategori/(.*)', 'Kategori::update/$1');
$routes->delete('admin/kategori/(.*)', 'Kategori::delete/$1');


//subkategori
$routes->get('admin/subkategori', 'Subkategori::index');
$routes->get('admin/subkategori/(.*)', 'Subkategori::show/$1');
$routes->post('admin/subkategori', 'Subkategori::create');
$routes->post('admin/subkategori/(.*)', 'Subkategori::update/$1');
$routes->delete('admin/subkategori/(.*)', 'Subkategori::delete/$1');


//iklan
$routes->get('admin/iklan', 'Iklan::index');
$routes->get('admin/iklan/(.*)', 'Iklan::show/$1');
$routes->post('admin/iklan', 'Iklan::create');
$routes->post('admin/iklan/(.*)', 'Iklan::update/$1');
$routes->delete('admin/iklan/(.*)', 'Iklan::delete/$1');
